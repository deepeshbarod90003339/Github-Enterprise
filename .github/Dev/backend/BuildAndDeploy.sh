...
echo "🚀 Deploying AI-Lab Backend to environment: $ENVIRONMENT"
echo
...
# Docker config
ECR_REPO="eda/services/dataplatform/datascience"
IMAGE_TAG="latest"
ECR_URI="$AWS_ACCOUNT_ID.dkr.ecr.$AWS_REGION.amazonaws.com/$ECR_REPO:$IMAGE_TAG"

# Kubernetes config
NAMESPACE="eda-services"
DEPLOYMENT_NAME="eda-services-ailabinfra-deploy"
SERVICE_NAME="eda-services-ailabinfra-svc"
...
echo " "
echo "🎉 AI-Lab Backend deployment completed!"
if [ "$ENVIRONMENT" = "prod" ]; then
  echo "🌐 API accessible at: https://onedata-api.onetakeda.com/services/dataplatform/datascience"
else
  echo "🌐 API accessible at: https://1data-api-dev.onetakeda.com/services/dataplatform/datascience"
fi
echo " "